        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Billing Number" text={data?.billing_number} />

                <FormListItem label="Total Amount" text={data?.total_amount} />

                <FormListItem label="Gst Amount" text={data?.gst_amount} />

                <FormListItem label="Net Amount" text={data?.net_amount} />
